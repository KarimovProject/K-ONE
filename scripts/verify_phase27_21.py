...
async def run():
    ...
    async with async_playwright() as p:
        ...
        os.makedirs("C:\\IEMS\\qa_screenshots\\workspace_27_21b", exist_ok=True)
        
        # Capture Login Screenshots BEFORE logging in
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_LOGIN_LIGHT_1920.png", full_page=True)
        await page.click(".auth-theme-toggle")
        await page.set_viewport_size({'width': 390, 'height': 844})
        await page.wait_for_timeout(500)
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_LOGIN_390.png", full_page=True)
        ...
        # ==========================================
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_WORKSPACE_1920.png", full_page=True)
        
        await page.set_viewport_size({'width': 1366, 'height': 768})
        await page.wait_for_timeout(500)
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_WORKSPACE_1366.png", full_page=True)
        ...
        if page_width > 768:
            print(f"FAIL: Horizontal overflow detected on tablet: {page_width}px > 768px")
            sys.exit(1)
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_WORKSPACE_768.png", full_page=True)
        ...
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_WORKSPACE_390.png", full_page=True)
        
        # Open mobile actions dropdown
        await page.click(".user-dropdown-menu summary")
        await page.wait_for_timeout(500)
        await page.screenshot(path="C:\\IEMS\\qa_screenshots\\workspace_27_21b\\8012_WORKSPACE_390_MENU_OPEN.png", full_page=True)
