...
<section class="auth-brand-panel" aria-hidden="true">
  <div class="auth-brand-copy">
    <div class="logo-container">
      <img src="{% static 'img/k-one/k-one-login-illuminated.png' %}" alt="K-ONE Logo" class="brand-logo-large">
    </div>
...
print("Updated login template and app.css with illuminated K-ONE logo.")
